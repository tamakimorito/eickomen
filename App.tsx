...
import DaikoTab from './components/DaikoTab.tsx';
...
import { BoltIcon, FireIcon, WifiIcon, CloudIcon, ChatBubbleBottomCenterTextIcon, XCircleIcon, XMarkIcon, ClipboardDocumentCheckIcon } from '@heroicons/react/24/solid';
...
const TABS = [
  ...
  { id: 'agency', label: '代行', icon: ClipboardDocumentCheckIcon },
];
