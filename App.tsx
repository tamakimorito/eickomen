...
const Tab: React.FC<TabProps> = ({ id, label, icon: Icon, activeTab, onTabChange }) => (
    <button
        ...
        className={`flex items-center gap-2 px-3 sm:px-4 py-3 text-sm sm:text-base font-bold transition-colors duration-200 ease-in-out focus:outline-none -mb-px ${
            activeTab === id
            ? 'text-rose-700 border-b-4 border-rose-600 bg-amber-100'
            : 'text-amber-800 hover:text-rose-600 border-b-4 border-transparent'
        }`}
    >
        ...
        <div className="bg-amber-50 min-h-screen font-sans">
            ...
            <main className="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    <div className="bg-amber-50 p-6 rounded-2xl shadow-xl border border-amber-200">
            ...
            <button
                ...
                className="fixed bottom-6 right-6 bg-rose-700 text-white p-4 rounded-full shadow-lg hover:bg-rose-800 transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-200"
