    ...
    return (
        <div className="space-y-6">
                ...
                />
                 <div className="md:col-span-2">
                    ...
                    {gasRecordIdPrefix && gasRecordIdPrefix !== 'サカイ' && (
                       <p className="text-sm text-gray-500 mt-1">自動判定された販路: <span className="font-bold text-red-600">{idPrefixDescription}</span></p>
                    )}
                </div>
            </div>
            ...
            <div className="border-t-2 border-dashed border-blue-300 pt-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 p-4 bg-green-50/60 rounded-lg border border-green-200">
                    {isSumainoGas && (
                         <>
            ...
            <div className="border-t-2 border-dashed border-blue-300 pt-6 space-y-4">
                ...
                <div className="p-4 bg-green-50/60 rounded-lg border border-green-200 space-y-4">
                     <FormDateInput
                        label="ガス利用開始日"
                        name="gasOpeningDate"
