    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                    ...
                    {elecRecordIdPrefix && elecRecordIdPrefix !== 'サカイ' && (
                       <p className="text-sm text-gray-500 mt-1">自動判定された販路: <span className="font-bold text-green-700">{idPrefixDescription}</span></p>
                    )}
                </div>
            </div>
            ...
            <div className="border-t-2 border-dashed border-green-300 pt-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 p-4 bg-green-50/50 rounded-lg border border-green-200">
                ...
                {isQenes && (
                    <div className="pt-4 space-y-4">
                        ...
                        {formData.qenesIsCorporate && (
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-green-50/50 rounded-lg border border-green-200">
                                <FormInput 
                                    label="対応者（漢字）" 
