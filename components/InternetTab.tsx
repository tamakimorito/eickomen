...
const GmoDocomoForm = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                <h3 className="text-lg font-bold text-emerald-800">キャンペーン・オプション</h3>
            ...
            <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                <h3 className="text-lg font-bold text-emerald-800">申込者情報</h3>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                <h3 className="text-lg font-bold text-emerald-800">後確希望時間枠</h3>
                <div className="p-4 bg-emerald-50/50 rounded-lg border border-emerald-200 grid grid-cols-1 md:grid-cols-2 gap-4">
...
const AuHikariForm = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                <h3 className="text-lg font-bold text-emerald-800">お客様情報</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                <h3 className="text-lg font-bold text-emerald-800">プラン・キャンペーン情報</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
...
const FletsHikariTossForm = () => {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                <h3 className="text-lg font-bold text-emerald-800">プラン情報</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
