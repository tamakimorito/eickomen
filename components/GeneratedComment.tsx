...
const GeneratedComment = () => {
  ...
  return (
    <div className="bg-green-50/80 p-6 rounded-2xl shadow-xl border border-green-200">
      <div className="flex justify-between items-center border-b-2 border-dashed border-green-200 pb-4 mb-4">
        ...
        <div className="flex items-center gap-2">
           <button
              ...
              className="flex items-center gap-2 bg-white text-gray-700 font-bold py-2 px-3 rounded-lg border border-green-200 hover:bg-green-50 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 shadow-sm hover:shadow-md"
            ...
            <button
              onClick={handleCopy}
              className="flex items-center gap-2 bg-gradient-to-r from-red-600 to-green-600 text-white font-bold py-2 px-4 rounded-lg hover:from-red-500 hover:to-green-500 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 shadow-md hover:shadow-lg"
            >
      ...
      <textarea
        ...
        rows={20}
        className="w-full p-3 bg-green-50/60 border border-green-200 rounded-xl focus:ring-2 focus:ring-green-600 focus:border-green-600 transition duration-150 ease-in-out text-sm font-mono leading-relaxed"
