    ...
    <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-200">
      <div className="flex justify-between items-center border-b-2 border-dashed border-gray-200 pb-4 mb-4">
        <div className="flex items-center gap-3">
            <PencilSquareIcon className="h-7 w-7 text-emerald-800"/>
            <h2 className="text-2xl font-bold text-gray-700">生成コメント</h2>
        </div>
        <div className="flex items-center gap-2">
           <button
              onClick={handleResetRequest}
              className="flex items-center gap-2 bg-white text-gray-600 font-bold py-2 px-3 rounded-lg border border-gray-300 hover:bg-gray-100 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 shadow-sm hover:shadow-md"
