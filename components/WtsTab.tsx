                    ...
                    <div className="md:col-span-2">
                        ...
                        />
                         {formData.wtsShippingDestination === 'その他' && (
                            <div className="mt-2 p-4 bg-green-50 rounded-lg border border-green-200 grid grid-cols-1 gap-4">
                                <FormInput
                                    label="発送先 郵便番号"
                    ...
                    <div className="flex items-end gap-4">
                     ...
                     <div className="md:col-span-2">
                        ...
                        {formData.wtsMailingAddress === '現住所' && (
                            <div className="mt-2 p-4 bg-green-50 rounded-lg border border-green-200 grid grid-cols-1 md:grid-cols-2 gap-4">
                                <FormInput
