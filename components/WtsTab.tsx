        ...
        <div className="space-y-6">
            ...
            {wtsCustomerType === 'U-20' && (
                <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                    <h3 className="text-lg font-bold text-emerald-800">U-20プラン専用情報</h3>
            ...
            <div className="border-t-2 border-dashed border-emerald-300 pt-6 space-y-4">
                <h3 className="text-lg font-bold text-emerald-800">契約詳細</h3>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <FormInput
                        label="①名義"
                        name="contractorName"
                    ...
                    <div className="md:col-span-2">
                        ...
                        />
                         {formData.wtsShippingDestination === 'その他' && (
                            <div className="mt-2 p-4 bg-emerald-50/50 rounded-lg border border-emerald-200 grid grid-cols-1 gap-4">
                                <FormInput
                                    label="発送先 郵便番号"
                    ...
                    <div className="flex items-end gap-4">
                     ...
                     <div className="md:col-span-2">
                        ...
                        {formData.wtsMailingAddress === '現住所' && (
                            <div className="mt-2 p-4 bg-emerald-50/50 rounded-lg border border-emerald-200 grid grid-cols-1 md:grid-cols-2 gap-4">
                                <FormInput
